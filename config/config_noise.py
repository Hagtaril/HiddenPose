...
_C.PHASE = 'train' # 'eval' or 'continue_train'  or 'train'  or 'test'
...
_C.MODEL.MODE = 'lct'
_C.MODEL.COORD_REPRESENTATION = '3DHeatmap' # 'sa-simdr' #'3DHeatmap' #'2DHeatmap'#'heatmap'#'simdr'
_C.MODEL.NUM_JOINTS = 24
_C.MODEL.BACKBONE = 'posenet3d_50'
_C.MODEL.PRETRAIN_AUTOENCODER = False
...
# _C.DATASET.TRAIN_PATH = "/data1/nlospose/pose_v2/" # data without noise 
_C.DATASET.TRAIN_PATH = "/data2/nlospose/pose_v2_noise"
_C.DATASET.VALID_PATH = "/data2/nlospose/pose_v2_noise"
_C.DATASET.TEST_PATH = "/data2/nlospose/pose_v2_noise"
